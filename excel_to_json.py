...
CURRENCY_ALIASES = {
    # Collapse the split vocabulary: the facet used to hold the same money
    ...
    'BEF': 'Belgian franc',
    'Belgian Francs': 'Belgian franc',
    'British Pounds': 'British pound sterling',
    'British pounds sterling': 'British pound sterling',
    'GBP': 'British pound sterling',
    'Pound sterling': 'British pound sterling',
    'Pounds': 'British pound sterling',
    ...
    'Yuan': 'Chinese yuan',
    'CUP': 'Cuban peso',
    'Dutch Guilders': 'Dutch guilder',
    'Dutch guilder (ƒ)': 'Dutch guilder',
    'Dutch guilders': 'Dutch guilder',
    'Guilder': 'Dutch guilder',
    'Guilders': 'Dutch guilder',
    'NLG': 'Dutch guilder',
    'EGP': 'Egyptian pound',
    'EUR': 'Euro',
    'FRF': 'French franc',
    'Francs': 'French franc',
    'French Francs': 'French franc',
    'French francs': 'French franc',
    'DEM': 'German mark',
    'German Marks': 'German mark',
    'German mark (Reichsmark)': 'German mark',
    'Marks': 'German mark',
    'Drachmas': 'Greek drachma',
    'GRD': 'Greek drachma',
    'HUF': 'Hungarian forint',
    'ITL': 'Italian lira',
    'Italian Lira': 'Italian lira',
    'Italian lire': 'Italian lira',
    'JPY': 'Japanese yen',
    'Yen': 'Japanese yen',
    'MXN': 'Mexican peso',
    'PEN': 'Peruvian sol',
    ...
    'RON': 'Romanian leu',
    'RUB': 'Russian ruble',
    'Roubles': 'Russian ruble',
    'Rubles': 'Russian ruble',
    'Russian Roubles': 'Russian ruble',
    'Russian rouble': 'Russian ruble',
    'Russian rubles': 'Russian ruble',
    'RSD': 'Serbian dinar',
    'ESP': 'Spanish peseta',
    'Pesetas': 'Spanish peseta',
    'Spanish Pesetas': 'Spanish peseta',
    'TRY': 'Turkish lira',
    'Turkish lira (livre turque)': 'Turkish lira',
